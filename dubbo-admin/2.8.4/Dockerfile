...
ADD dubbo-admin-2.8.4.war /tomcat-7.0.79/webapps
ADD entrypoint.sh /

RUN unzip -q /tomcat-7.0.79/webapps/dubbo-admin-2.8.4.war -d /tomcat-7.0.79/webapps/ROOT \
    && rm -fr /tomcat-7.0.79/webapps/dubbo-admin-2.8.4.war \
